...
@Getter
@Setter
@Table(name = "JOB_LOCALIZATION")
@FieldNameConstants
@IdClass(LocalizationId.class)
@NoArgsConstructor
@ToString
public class JobLocalization extends BaseEntity implements Serializable {
    ...
    public JobLocalization(long provinceId, String locale, String content, Long createdBy) {
        super(createdBy);
        this.id = provinceId;
        this.locale = locale;
    ...
    public boolean equals(Object o) {
        ...
        JobLocalization hotelType = (JobLocalization) o;
