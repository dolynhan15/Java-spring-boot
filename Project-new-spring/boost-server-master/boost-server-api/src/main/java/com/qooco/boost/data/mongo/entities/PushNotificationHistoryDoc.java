...
@NoArgsConstructor
@AllArgsConstructor
@Document(collection = "PushNotificationHistoryDoc")
public class PushNotificationHistoryDoc {
    @Id
    private ObjectId id;
    ...
    public PushNotificationHistoryDoc(Object message, PushMessageResponse response) {
        setRequestId(response.getRequestId());
        setMessageId(response.getMessageId());
        setSendTime(response.getSendTime());
