...
@NoArgsConstructor
@ToString
public class LanguageLocalization extends BaseEntity implements Serializable {
    ...
    public LanguageLocalization(long provinceId, String locale, String content, Long createdBy) {
        super(createdBy);
        this.id = provinceId;
        this.locale = locale;
    ...
    public boolean equals(Object o) {
        ...
        LanguageLocalization hotelType = (LanguageLocalization) o;
